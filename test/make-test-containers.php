...
#   cd $SHARED_HOST_FOLDER && git clone https://github.com/nusantara-panel/nusantara.git && cd hestiacp && git checkout ..branch..
#
...
function getHestiaVersion($branch) {
	...
	if ($branch === "~localsrc") {
		...
		$control_file = file_get_contents(
			"https://raw.githubusercontent.com/nusantara-panel/nusantara/${branch}/src/deb/hestia/control",
		);
	}
