...
#===========================================================================#
#                                                                           #
# Nusantara Panel - System Health Check and Repair Function Library    #
#                                                                           #
#===========================================================================#
...
function syshealth_repair_system_config() {
	...
	if [[ -z $(check_key_exists 'APP_NAME') ]]; then
		echo "[ ! ] Adding missing variable to hestia.conf: APP_NAME ('Nusantara Panel')"
		$BIN/v-change-sys-config-value "APP_NAME" "Nusantara Panel"
	fi
