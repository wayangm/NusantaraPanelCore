						...
						<?php if ($v_mysql == "yes") { ?>
							...
							<div class="u-mb10">
								<label for="v_phpmyadmin_key" class="form-label">
									...
									<span class="hint">
										<a
											href="https://nusantarapanel.local/docs/server-administration/databases.html"
											target="_blank"
										>
											(<?= tohtml( _("More info")) ?>)
										</a>
				...
				<div class="box-collapse-content">
					...
					<div class="u-mb10">
						<label for="v_backup_mode" class="form-label">
							...
							<a
								href="https://nusantarapanel.local/docs/server-administration/backup-restore.html#what-is-the-difference-between-zstd-and-gzip"
								target="_blank"
								class="u-ml5"
							>
					...
					<div class="u-mb10">
						<label for="v_backup_gzip" class="form-label">
							...
							<a
								href="https://nusantarapanel.local/docs/server-administration/backup-restore.html#what-is-the-optimal-compression-ratio"
								target="_blank"
								class="u-ml5"
							>
								<i class="fas fa-circle-question"></i>
					...
					<div class="u-mb20">
						<label for="v_backup_dir" class="form-label">
							<?= tohtml( _("Directory")) ?>
							<a
								href="https://nusantarapanel.local/docs/server-administration/backup-restore.html#how-to-change-default-backup-folder"
								target="_blank"
								class="u-ml5"
							>
								<i class="fas fa-circle-question"></i>
					...
					<div x-cloak x-show="remoteBackupEnabled" class="u-pl30 u-mt20">
						<div class="u-mb10">
							<label for="backup_type" class="form-label">
								<?= tohtml( _("Protocol")) ?>
								<a
									href="https://nusantarapanel.local/docs/server-administration/backup-restore.html#what-kind-of-protocols-are-currently-supported"
									target="_blank"
									class="u-ml5"
								>
									<i class="fas fa-circle-question"></i>
