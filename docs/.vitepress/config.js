...
export default defineConfig({
	...
	themeConfig: {
		...
		socialLinks: [
			{ icon: 'github', link: 'https://github.com/nusantara-panel/nusantara' },
		...
		editLink: {
			pattern: 'https://github.com/nusantara-panel/nusantara/edit/main/docs/:path',
			text: 'Edit this page on GitHub',
		},

		footer: {
			message: 'Released under the GPLv3 License.',
			copyright: 'Copyright © 2019-present Nusantara Panel',
		},
...
function nav() {
	return [
		...
		{ text: 'Team', link: '/team' },
		{ text: 'Demo', link: 'https://demo.nusantarapanel.local:8083/' },
		{ text: 'Forum', link: 'https://forum.nusantarapanel.local/' },
		{ text: 'Donate', link: '/donate' },
		{
			...
			items: [
				{
					text: 'Changelog',
					link: 'https://github.com/nusantara-panel/nusantara/blob/main/CHANGELOG.md',
				},
				{
					text: 'Contributing',
					link: 'https://github.com/nusantara-panel/nusantara/blob/main/CONTRIBUTING.md',
				},
				{
					text: 'Security policy',
					link: 'https://github.com/nusantara-panel/nusantara/blob/main/SECURITY.md',
				},
			],
		},
	];
