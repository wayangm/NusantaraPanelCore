...
# Nusantara Panel upgrade script for target version 1.00.0-190618
...
if [ -d $HESTIA/install/ubuntu ]; then
	echo "[ * ] Removing old NusantaraCP installation files for Ubuntu..."
	rm -rf $HESTIA/install/ubuntu
fi
if [ -d $HESTIA/install/debian ]; then
	echo "[ * ] Removing old NusantaraCP installation files for Debian..."
