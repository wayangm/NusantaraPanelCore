...
# ======================================================== #
#
# Nusantara Panel Installer for Debian
...
help() {
  ...
  Example: bash $0 -e demo@nusantarapanel.local -p p4ssw0rd --multiphp yes"
	exit 1
}
...
# Welcome message
echo "Welcome to the Nusantara Panel installer!"
echo
...
if [ -n "$conflicts" ] && [ -z "$force" ]; then
	...
	if [ "$answer" = 'y' ] || [ "$answer" = 'Y' ]; then
		...
		check_result 1 "Nusantara Panel should be installed on a clean server."
	fi
fi
...
if [ -z "$withdebs" ] || [ ! -d "$withdebs" ]; then
	...
	if [ "$HESTIA_INSTALL_VER" != "$release_branch_ver" ]; then
		...
		echo ""
		# # # # # check_result 1 "Installation aborted" # Disabled for Nusantara # Disabled for Nusantara # Disabled for Nusantara # Disabled for Nusantara # Disabled for Nusantara
	fi
fi
...
install_welcome_message() {
	...
	echo "========================================================================"
	echo
	echo "Thank you for downloading Nusantara Panel! In a few moments,"
...
echo "[ * ] Configuring Nusantara Panel..."
...
$HESTIA/bin/v-generate-ssl-cert $(hostname) '' 'US' 'California' \
	'San Francisco' 'Nusantara Panel' 'IT' > /tmp/hst.pem
...
echo "[ * ] Adding SSL certificate to Nusantara Panel..."
cd $HESTIA/ssl
...
# Get public IP
pub_ipv4="$(curl -fsLm5 --retry 2 --ipv4 https://ip.nusantarapanel.local/)"
...
You have successfully installed Nusantara Panel on your server.
...
Thank you for choosing Nusantara Panel to power your full stack web server,
we hope that you enjoy using it as much as we do!

Please feel free to contact us at any time if you have any questions,
or if you encounter any bugs or problems:

Documentation:  https://docs.nusantarapanel.local/
Forum:          https://forum.nusantarapanel.local/
GitHub:         https://www.github.com/nusantara-panel/nusantara

Note: Automatic updates are enabled by default. If you would like to disable them,
please log in and navigate to Server > Updates to turn them off.

Help support the Nusantara Panel project by donating via PayPal:
https://www.nusantarapanel.local/donate

--
Sincerely yours,
The Nusantara Panel development team

Made with love & pride by the open-source community around the world.
" >> $tmpfile

send_mail="$HESTIA/web/inc/mail-wrapper.php"
cat $tmpfile | $send_mail -s "Nusantara Panel" $email
...
$HESTIA/bin/v-add-user-notification "$username" 'Welcome to Nusantara Panel!' '<p>You are now ready to begin adding <a href="/add/user/">user accounts</a> and <a href="/add/web/">domains</a>. For help and assistance, <a href="https://nusantarapanel.local/docs/" target="_blank">view the documentation</a> or <a href="https://forum.nusantarapanel.local/" target="_blank">visit our forum</a>.</p><p>Please <a href="https://github.com/nusantara-panel/nusantara/issues" target="_blank">report any issues via GitHub</a>.</p><p class="u-text-bold">Have a wonderful day!</p><p><i class="fas fa-heart icon-red"></i> The Nusantara Panel development team</p>'
